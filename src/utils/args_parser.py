...
class ExperimentArguments:
    ...
    seed: int = field(default=183, metadata={"help": "| Seed for reproducibility | ==> required"})
    epochs: int = field(
    ...
    devices: str | None = field(
        default=None,
        metadata={"help": "Devices to be used for training. Can be an int or a list of ints."},
    )
    optimal_lr: float | None = field(
        default=None,
        metadata={"help": "Optimal learning rate to be found by the Learning Rate Finder"},
    )
