...
class MidEpochCheckpointCallback(Callback):
    ...
    def _save_lora_weights(self, pl_module: pl.LightningModule, epoch: int, step: int) -> None:
    ...
    def _perform_mid_epoch_eval(self, pl_module: pl.LightningModule, epoch: int, step: int) -> None:
